...
model_dcscn.load_state_dict(
    torch.load("model_check_points/DCSCN/DCSCN_weights_387epos_L12_noise_1.pt")
)
...
model_cran_v2.load_state_dict(
    torch.load("model_check_points/CRAN_V2/CARN_model_checkpoint.pt")
)
model_cran_v2 = model_cran_v2.float()

img_dataset = ImageData(
    img_folder="dataset/sp_twitter",
    patch_size=96,
    shrink_size=2,
    noise_level=1,
